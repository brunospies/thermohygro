...
set_property PACKAGE_PIN E16 [get_ports validation]						
set_property IOSTANDARD LVCMOS33 [get_ports validation]
###Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
set_property PACKAGE_PIN F15 [get_ports Saut_ligne]						
set_property IOSTANDARD LVCMOS33 [get_ports Saut_ligne]
